...
<div>
  <div class="container">
    <section class="section-heading">
      <div class="text-zone">
        <div class="large row" id="header">
          <div class="col-12 text-center">
            <span class="animate_animated hover" 
              v-for="item in headings" 
              :key="item.id" 
              :id="item.id" 
              @mouseenter="item.active = true;" 
              @mouseleave="item.active = false" 
              @mouseover="removeShaking" 
              :class="{animate__rubberBand : item.active}">
                {{ item.name }}
              </span>
          </div>
        </div>
        <div class="svg-image row mt-5">
          <div class="col-sm-12 col-md-12 col-lg-6 mb-5">
            ...
            <div class="contact background mt-4" id="copyEmail" @click="copied">
              <div class="icon">
                <img src="./../assets/email.png" alt="">
              </div>
              <p class="mail">milosstojsavljevic93@gmail.com</p>
              <span class="copied hide">Copied!</span>
            </div>
          </div>
          <div class="col-sm-12 col-md-12 col-lg-6">
            <svg id="researcher" width="803" height="591" viewBox="0 0 803 591" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path id="Vector_16" d="M464.906 92.9492L802.027 92.9492V83.0603L464.906 83.0603V92.9492Z" fill="white"/>
            <path id="Vector_17" d="M688.754 85.7573L774.158 85.7573V0.353165L688.754 0.353165V85.7573Z" fill="white"/>
            <path id="Vector_18" d="M705.835 68.6765H757.077V17.434L705.835 17.434V68.6765Z" fill="#CE7A9A"/>
            <path id="Vector_19" d="M561.097 85.7573H582.673V0.353165H561.097V85.7573Z" fill="white"/>
            <path id="Vector_20" d="M561.097 23.7269L582.673 23.7269V13.838L561.097 13.838V23.7269Z" fill="#87FFB7"/>
            <path id="Vector_21" d="M561.097 66.8784H582.673V56.9895H561.097V66.8784Z" fill="#87FFB7"/>
            <path id="Vector_22" d="M594.36 85.7573H615.936V0.353165H594.36V85.7573Z" fill="white"/>
            <path id="Vector_23" d="M594.36 23.7269L615.936 23.7269V13.838L594.36 13.838V23.7269Z" fill="#87FFB7"/>
            <path id="Vector_24" d="M594.36 66.8784H615.936V56.9895H594.36V66.8784Z" fill="#87FFB7"/>
            <path id="Vector_25" d="M504.614 76.5375L523.95 86.1104L561.843 9.573L542.507 4.33597e-05L504.614 76.5375Z" fill="white"/>
            <path id="Vector_26" d="M532.137 20.9471L551.472 30.5201L555.86 21.6578L536.524 12.0849L532.137 20.9471Z" fill="#87FFB7"/>
            <path id="Vector_27" d="M512.991 59.6187L532.326 69.1917L536.714 60.3294L517.378 50.7565L512.991 59.6187Z" fill="#87FFB7"/>
            ...
            <path id="Vector_30" d="M715.724 32.7168C719.199 32.7168 722.017 29.8994 722.017 26.4239C722.017 22.9484 719.199 20.131 715.724 20.131C712.248 20.131 709.431 22.9484 709.431 26.4239C709.431 29.8994 712.248 32.7168 715.724 32.7168Z" fill="white"/>
            ...
            <path id="Vector_71" d="M168.246 295.442L132.143 283.031C132.143 283.031 98.2971 258.211 106.195 283.031C114.092 307.852 150.195 362.006 160.349 356.365C170.502 350.724 182.714 336.722 179.993 334.697C177.272 332.673 159.22 318.006 168.246 295.442Z" fill="#2F2E41"/>
            </g>
            <g id="arms">
...
export default {
  ...
  data() {
    return {
      isActive: false,
      headings: [
        { id: 1, name: "H" , active: false },
        { id: 2, name: "i", active: false },
        { id: 3, name: ",", active: false },
        { id: 4, name: "  ", active: false },
        { id: 5, name: "I", active: false },
        { id: 6, name: "'", active: false },
        { id: 7, name: "m", active: false },
        { id: 8, name: "  ", active: false },
        { id: 9, name: "M", active: false },
        { id: 10, name: "i", active: false },
        { id: 11, name: "l", active: false },
        { id: 12, name: "o", active: false },
        { id: 13, name: "s", active: false }
      ]
    }
  },
  mounted() {
...
.section-heading {
  ...
  #researcher {
    ...
    #Vector_70 {
      animation: otherLeg 3s ease 2s infinite;
      animation-name: otherLeg;
    ...
    #Vector_71 {
      animation: legs 3s ease 2s infinite;
      animation-name: legs;
      animation-duration: 3s;
      animation-timing-function: ease;
      animation-delay: 1s;
